...
class Profile(models.Model):
    ...
    how_did_you_hear_about_us: models.CharField = models.CharField(
        null=True, max_length=350
    )
    facebook_link: models.CharField = models.CharField(
        blank=True, null=True, max_length=200
    )
    instagram_link: models.CharField = models.CharField(
        blank=True, null=True, max_length=200
    )
    twitter_link: models.CharField = models.CharField(
        blank=True, null=True, max_length=200
    )
